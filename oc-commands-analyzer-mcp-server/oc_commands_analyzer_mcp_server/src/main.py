"""Main entry point for the OC Commands Analyzer MCP Server."""
...
from oc_commands_analyzer_mcp_server.src.api import app
from oc_commands_analyzer_mcp_server.src.settings import settings
from oc_commands_analyzer_mcp_server.src.settings import (
...
def validate_config() -> None:
    ...
    beyond what's done in the Settings class initialization.
...
def main() -> None:
    ...
    Initializes logging, loads configuration, and starts the OC Commands Analyzer MCP server.
...
def run() -> None:
    ...
    shutdown and proper exit codes.
