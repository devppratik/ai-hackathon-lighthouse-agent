"""Settings for the OC Commands Analyzer MCP Server."""
...
class Settings(BaseSettings):
    """Configuration settings for the OC Commands Analyzer MCP Server.
    ...
    COMPATIBLE_WITH_CURSOR: bool = Field(
        ...
        json_schema_extra={
            ...
            "description": "Whether the MCP server is compatible with Cursor",
            "example": True,
        },
    )
